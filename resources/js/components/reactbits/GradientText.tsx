...
export default function GradientText({
  ...
  return (
    <motion.span
      className={`inline-flex items-center justify-center ${showBorder ? 'py-1 px-2' : ''} ${className}`}
    ...
    >
      {showBorder && (
        ...
        >
          <span className="absolute bg-black rounded-[1.25rem] z-[-1]" style={{ width: 'calc(100% - 2px)', height: 'calc(100% - 2px)', left: '50%', top: '50%', transform: 'translate(-50%, -50%)' }} />
        </motion.span>
      )}
      <motion.span
