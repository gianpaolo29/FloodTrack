    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-col gap-6 p-6 lg:p-8">
                ...
                {/* Reports table */}
                <div className="rounded-2xl border border-neutral-200/60 bg-white shadow-sm dark:border-neutral-700/60 dark:bg-neutral-900 overflow-hidden">
                    {/* Card header */}
                            ...
                            <table className="w-full min-w-[700px] border-collapse">
                                <thead>
                                    <tr className="bg-neutral-50/60 dark:bg-neutral-800/30 border-b border-neutral-100 dark:border-neutral-800">
                                        ...
                                        <th className="px-4 py-4 text-left text-[11px] font-semibold uppercase tracking-wider text-neutral-400 dark:text-neutral-500">
                                            Report
                                        </th>
                                        <th className="px-4 py-4 text-left text-[11px] font-semibold uppercase tracking-wider text-neutral-400 dark:text-neutral-500">
                                            Severity
        ...
        >
            ...
            <td className="px-4 py-4">
                <Link
                    ...
                    className="inline-flex items-center gap-1.5 rounded-lg bg-sky-50 px-3 py-1.5 text-xs font-semibold text-sky-600 transition-colors hover:bg-sky-100 dark:bg-sky-950/30 dark:text-sky-400 dark:hover:bg-sky-950/60"
                >
